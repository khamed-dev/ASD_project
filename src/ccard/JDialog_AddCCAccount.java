...
{
	private FincoGui parentframe;
    
	public JDialog_AddCCAccount(FincoGui parent)
	{	
		parentframe=parent;
		
		// This code is automatically generatzed by Visual Cafe when you add
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
       ...
       ((CcardGui)parentframe).ccnumber=JTextField_CCNR.getText();
       ((CcardGui)parentframe).expdate=JTextField_ExpDate.getText();
